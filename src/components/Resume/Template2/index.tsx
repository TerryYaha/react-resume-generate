            ...
            <div className="section section-project">
              {_.map(projectList, (project, idx) =>
                project ? (
                  <div className="section-item" key={idx.toString()}>
                    <div className="section-info">
                      <b className="info-name project-name">
                    ...
                    <div className="section-detail">
                      <span className="project-content-title">
                        {i18n.get('主要工作')}：
                      </span>
                    ...
                    {project?.project_hard && (
                      <div className="section-detail">
                        <span className="project-hard-title">
                          {i18n.get('项目难点')}：
                        </span>
                        <span>{project.project_hard}</span>
                      </div>
                    )}
                  </div>
                ) : null
